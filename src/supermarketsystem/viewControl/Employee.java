...
import supermarketsystem.Controller.EmployeeControl;
import supermarketsystem.Controller.ProductControl;
import supermarketsystem.model.EmployeeModel;
...
public class Employee implements Initializable{
    ...
    int ID;
    String  TypeProduct[]={"Menadžer", "Blagajnik"};
