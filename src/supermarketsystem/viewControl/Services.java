package supermarketsystem.viewControl;
...
import supermarketsystem.Controller.ServicesControl;
...
public class Services implements Initializable{
 ...
 public void Back(Event e)
 {
    try {
       ...
       Parent root = FXMLLoader.load(getClass().getResource("/supermarketsystem/viewFXML/Home.fxml"));       
 ...
 public void Search(){
  ...
  public void Buy(){
      ...
      bill.setText(s+"Naziv Proizvoda : "+table.getValue()+"\n"+"Cijena Proizvoda : "+txtPrice.getText()+" KM\n"
      +"Popust na Proizvod : "+txtDiscount.getText()+"%\n--------------------------------------\n"
      );
  ...
  public void Print() {
        try {
            num++;
             ...
             PrintWriter f = new PrintWriter("Račun "+String.valueOf(num)+".txt");
