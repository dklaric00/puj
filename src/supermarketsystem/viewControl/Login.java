...
import supermarketsystem.Controller.ConnectionDB;
import supermarketsystem.Controller.LoginControl;
    ...
    public void isSign(Event event) {
            ...
            if (rg.isLogin(lg)) {
                try {
                   ...
                   Parent root = FXMLLoader.load(getClass().getResource("/supermarketsystem/viewFXML/Services.fxml"));       
                   Scene scene = new Scene(root);       
                   stage.setScene(scene);
                   stage.show();
                   }
